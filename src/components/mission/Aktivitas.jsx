    ...
    return (
        <div className='text-center'>
            <div className="flex justify-between items-center my-5">
                ...
                <Link to='/history'><button className={`border-2 text-sm rounded-3xl p-2 bg-ungu1 text-white hover:bg-dark-main-color focus:bg-ungu3 focus:outline-none ${!hasActivities ? 'invisible' : '' }`} onClick={() => window.scrollTo(0, 0)}>Lihat Riwayat</button></Link>                
            </div>
