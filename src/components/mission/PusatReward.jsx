...
export default function PusatReward({ }) {
  ...
  return (
    <div className="bg-white sm:p-5 md:p-10 p-3 rounded-[40px] flex flex-col justify-center">
      <h1 className="text-center text-2xl md:text-4xl mb-4 font-bold">Pusat Reward</h1>

      {/* container for reward */}
      <div className="bg-white rounded-[40px] shadow-md flex-none lg:flex pb-sm-3 pb-md-4 pb-2 ps-sm-3 ps-md-4 ps-2">
        ...
        {/* member reward item */}
        <div className="text-center lg:w-1/3 p-sm-3 p-md-4 p-4">
          <h3 className='text-xl font-semibold'>Ayah</h3>
          <h4 className='text-[20px] md:text-2xl font-bold my-3'>Ditraktir bunda di alun kota</h4>
        ...
        <div className="text-center lg:w-1/3 p-sm-3 p-md-4 p-4">
          ...
          <h4 className='text-[20px] md:text-2xl font-bold my-3'>Bunda dapet hadiah sepatu Branded</h4>
      ...
      {/* summary card */}
      <div className="p-sm-3 p-md-4 p-8 px-sm-4 px-md-5 px-4 mb-4 mx-md-5 bg-white shadow-md rounded-[40px]">
        <h1 className="text-center text-2xl md:text-4xl font-bold">Ringkasan</h1>
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 text-center">
          <SummaryCard title='Ayah Idaman' value='60' fontSz='text-3xl' description='Selesaikan banyak misi untuk menaikan score' firstRow={94} />
          <SummaryCard title='Bunda Idaman' value='60' fontSz='text-3xl' description='Selesaikan banyak misi untuk menaikan score' firstRow={94} />
          <SummaryCard title='Daily Mission' value='60' fontSz='text-3xl md:text-6xl' description='Misi diselesaikan on time (per 30 hari)' />
          <SummaryCard title='Daily Mission' value='2' fontSz='text-3xl md:text-6xl' description='Misi diselesaikan overdue (per 30 hari)' />
          <SummaryCard title='Kategori' value='4' fontSz='text-3xl md:text-6xl' description='Kategori yang telah dilaksanakan (per 30 hari)' />
          <SummaryCard title='Kategori' value='Baby Care' fontSz='text-xl md:text-3xl' description='Paling banyak dilaksanakan (per 30 hari)' />
        </div>
      </div>
    </div>
  )
