...
//       <h1 className="mt-6 text-center font-black text-4xl my-4 text-main-color">
//         Our Special Service or Feature
//       </h1>
...
//         <div className="w-full md:w-[30%] text-main-color">
//           <h1 className="text-4xl font-bold text-left mt-8 py-2 px-6">
//             Pekerjaan Rumah Tangga <br />
//             & Menemani Si Kecil <br />
//             Jadi Lebih Seru!
//           </h1>
//           <h4 className="text-xl font-normal text-left py-2 px-6 text-balck-color">
//             Fitur yang memudahkan Ayah dan Bunda dalam melakukan{" "}
//             <span className="italic">daily activity </span> seperti pembagian
//             tugas rumah tangga, menemani si kecil bermain hingga jadwal{" "}
//             <span className="italic">quality time</span> secara berkala.
//           </h4>
//           <div className="grid grid-rows-1 grid-flow-col px-6">
//             <div className="flex justify-start mt-6 mb-2 gap-8">
//               <div>
//                 <img
...
//           <div className="mt-6 px-6 text-left">
//             <a
//               className="text-xl font-medium bg-main-color text-white rounded-md p-4 inline-block shadow-lg hover:bg-tertiery"
//               href="http://"
//             >
//               Jelajahi Mission Sekarang!
//             </a>
//           </div>
//         </div>
//       </div>
