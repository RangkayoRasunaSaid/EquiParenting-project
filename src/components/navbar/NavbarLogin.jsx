                ...
                {navMenu.map(({ link, path }) => {
                  ...
                  return (
                    <Link
                      key={link}
                      to={path}
                      className={`text-lg block py-[4px] px-[16px] rounded-2xl hover:bg-secondary-color hover:font-medium transition-none ${
                        isActive ? "bg-secondary-color font-medium transition-none" : ""
                      }`}
